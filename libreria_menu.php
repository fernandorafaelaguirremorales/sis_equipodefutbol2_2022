...
if (isset($_SESSION["sesion_id_rol"])){
        ...
        $sql1 = $db->Prepare("SELECT nombre,logo
            ...
            if ($cuerp == false){
                echo" <img src='../escuela_futbol/logos/{$logo}' width='10%'>"; 
            }
            else{
                echo" <img src='privada/escuela_futbol/logos/{$logo}' width='10%'>";
                }
                echo"<div class='titulo'>";
                echo "SISTEMA WEB {$nombre}";
                echo"</div>";
                echo"<div class='usuario'>";
                echo " &nbsp;&nbsp &nbsp;&nbsp; USUARIO: <b>".$_SESSION["sesion_usuario"]."</b> &nbsp;&nbsp; ";
            ...
            echo"<div id='header'>
                 <ul class='nav'>";
                        ...
                        foreach($rs as $r => $fila){
                            echo"<li>";
                            if ($grup != $fila["grupo"]){
                                echo"<a onclick='locatio.href=\"#\"' style='cursor:pointer;'>".$fila["grupo"]."</a>";
                                $grup = $fila["grupo"];
                            }
                            echo"<ul>";
                                foreach ($rs2 as $t => $fila2){
                                    if($grup == $fila2["grupo"]){
                                        ...
                                        echo"<li><a onclick='location.href=\"sis_equipodefutbol2_2022/".$fila2["contenido"]."\"' ' style='cursor:pointer;'>".$fila2["opcion"]."</a></li>";
                                    }
                                }
                                echo"</ul>";
                        echo"</li>";
                        ...
                        echo"</ul>";
                        if ($cuerp == false){
                            echo"<a onclick='location.href=\"../../validar,php\"'><input type='button'name='accion' value='Cerrar Sesion' style='cursor:pointer;borde-radius:10px;font-weight: bold;height: 25px;' class='boton_cerrar'></a>";
                        }else{
                            echo"<a onclick='location.href=\"validar,php\"'><input type='button' name='accion' value='Cerrar Sesion' style='cursor:pointer;borde-radius:10px;font-weight: bold;height: 25px;' class='boton_cerrar'></a>";
                        }
                        echo"</ul>";
