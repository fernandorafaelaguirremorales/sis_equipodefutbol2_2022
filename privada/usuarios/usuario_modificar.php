...
$sql1 = $db->Prepare("SELECT CONCAT_WS(' ' ,ap, am, nombre) as persona, id_persona
                     FROM personas
                     WHERE id_persona=?
                     AND estado = 'A'                        
                        ");
...
$sql2 = $db->Prepare("SELECT CONCAT_WS(' ' ,ap, am, nombre) as persona, id_persona
                     FROM personas
                     WHERE id_persona <>?
                     AND estado = 'A'                        
                        ");
        ...
        echo"<center>
                ...
                echo"</select>
                  ...
                  foreach ($rs as $k => $fila){
                    ...
                    <td><input type='text' name='nom_usu' size='10' value='".$fila["nom_usu"]."'></td>
                    </tr>
